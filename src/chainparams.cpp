...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x00000a49ec81e566b6013e403ef710dae79742be34c920ec6ace4e0897879c7f"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1525929087, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nStartMasternodePayments = 1525929087; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1525929088;
        genesis.nNonce = 23041461;
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet CryptoCashBack BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet CryptoCashBack BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet CryptoCashBack BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1525929088;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
