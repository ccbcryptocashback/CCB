...
#if defined(NDEBUG)
#error "CryptoCashBack cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "CryptoCashBack Signed Message:\n";
...
{
    RenameThread("cryptocashback-scriptch");
